package com.sabinadobria.projects.hotelapp.dao;
...
public class HotelServiceDAOImpl implements HotelServiceDAO {
	...
	public List<Booking> searchBookingByUserId(String id) {
		...
		rows.stream().map((row) -> {
			...
			booking.setId(String.valueOf(row.get("id")));
			booking.setHotelId(String.valueOf(row.get("hotel_id")));
			booking.setRooms((String) row.get("rooms"));
			booking.setSelectedDate((String) row.get("selectdate"));
			booking.setLeaveDate((String) row.get("leavedate"));
			booking.setUserId(String.valueOf(row.get("user_id")));
			booking.setPeople((String) row.get("people"));
	...
	public void creteBooking(String rooms, String people, String id, String date, String leavedate, String user_id) {
		jdbcTemplate.update("insert into booking (user_id, hotel_id, rooms, selectdate, leavedate, people) values (?,?,?,?,?,?)",
				new Object[] {user_id,id,rooms,date, leavedate, people});
	...
	@Override
	public void updateBooking(String id, String rooms, String people, String date, String leavedate) {
		jdbcTemplate.update("update booking set rooms = ?, selectdate = ?, leavedate = ?, people = ? where id = ?",
				new Object[] { rooms, date, leavedate, people, id });
	...
	public void createUser(String fname, String lname, String emailTxt, String pwd) {
		jdbcTemplate.update("insert into users (first_name, last_name, email_id, password) values (?,?,?,?)",
				new Object[] {fname,lname,emailTxt,passwordEncoder.encode(pwd)});
